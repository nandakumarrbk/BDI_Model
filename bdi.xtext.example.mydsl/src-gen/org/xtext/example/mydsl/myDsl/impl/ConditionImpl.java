 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ConditionImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends MinimalEObjectImpl.Container implements Condition
{
  ...
  public EList<String> getStatements()
  {
    if (statements == null)
    {
      statements = new EDataTypeEList<String>(String.class, this, MyDslPackage.CONDITION__STATEMENTS);
    }
    return statements;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.CONDITION__STATEMENTS:
